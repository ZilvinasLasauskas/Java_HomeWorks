...
public class op012 {
    ...
    public static void main(String[] args) {
        System.out.println("Kvadrato plotas: " + op012.squareCounter(11));
        System.out.println("Staciakampio plotas: " + op012.squareCounter(13, 15));
        System.out.println("Skritulio plotas: " + op012.squareCounter(16, Math.PI));
        System.out.println("Trikampio plotas: " + op012.squareCounter(16, 9, 2));
